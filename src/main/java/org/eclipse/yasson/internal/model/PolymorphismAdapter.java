...
/**
 * Predefined type components which is supposed to handle polymorphism.
 *
 ...
 * </pre>
 *
 * <p>With a Dog and Cat types which extend Animal, components can be configured like this:</p>
 *
 * <pre>
